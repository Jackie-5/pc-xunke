...
readRouteConfigFiles(
  `${process.cwd()}/${config.SERVICE_ROUTER.configDir}`,
  `${process.cwd()}/${config.SERVICE_ROUTER.actionDir}`
);
readRouteConfigFiles(
  `${process.cwd()}/${config.CLIENT_ROUTER.configDir}`,
  `${process.cwd()}/${config.CLIENT_ROUTER.actionDir}`
);
